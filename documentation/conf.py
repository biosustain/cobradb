# -*- coding: utf-8 -*-
#
# cobradb documentation build configuration file, created by
...
autoapi_dirs = [join(SRC_PATH, "cobradb"), join(SRC_PATH, "bin")]
...
from cobradb import __version__ as release  # noqa: E402

doc_name = f"{project} Documentation"
authors = "Pascal A. Pieters"
description = """BiGGr Models Backend."""
